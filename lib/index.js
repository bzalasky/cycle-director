...
function hijackLinks(router) {
  ...
  _cycleCore.Rx.Observable.fromEvent(document.body, 'DOMNodeInserted').debounce(100).subscribe(function (event) {
    var links = document.querySelectorAll('a');

    _cycleCore.Rx.Observable.fromEvent(links, 'click').subscribe(function (event) {
